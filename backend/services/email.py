...
async def send_password_reset_email(to_email: str, token: str):
    if not settings.brevo_api_key:
        print("Warning: BREVO_API_KEY is not set. Password reset email will not be sent.")
        return
                ...
                <tr>
                    <td align="center">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06); overflow: hidden; max-width: 600px; width: 100%;">
                            ...
                            <tr>
                                <td style="padding: 20px 40px 40px 40px;">
                                    <h2 style="margin: 0 0 20px 0; font-size: 20px; font-weight: 600; color: #18181b;">Password Reset Request</h2>
                                    <p style="margin: 0 0 24px 0; font-size: 16px; line-height: 24px; color: #52525b;">
                                        We received a request to reset your password for your CampusBite account. Click the button below to choose a new password.
                                    </p>
                                    <div style="text-align: center; margin-bottom: 24px;">
                                        <a href="{reset_link}" style="display: inline-block; background-color: #18181b; color: #ffffff; font-weight: 500; font-size: 16px; text-decoration: none; padding: 12px 32px; border-radius: 6px;">Reset Password</a>
                                    </div>
                                    <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 20px; color: #71717a;">
                                        If the button above doesn't work, copy and paste the following link into your browser:
                                    </p>
                                    ...
                                    <hr style="border: none; border-top: 1px solid #e4e4e7; margin: 0 0 24px 0;">
                                    <p style="margin: 0; font-size: 14px; color: #a1a1aa; text-align: center;">
                                        This link will expire in 15 minutes. If you did not request a password reset, please ignore this email or contact support if you have questions.
                                    </p>
                                </td>
                            </tr>
                        </table>
